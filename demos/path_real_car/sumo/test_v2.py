...
CSV_FILE   = "demos/path_real_car/trace_realistic_samebearing.csv"  # <‑‑‑ YOUR CSV TRACE HERE
...
try:
    ...
    while any(veh_traces.values()):
        # ── Apply one GPS fix per vehicle (if available) ────────────────
        print(traci.vehicle.getIDList())  # debug: show current vehicles
